...
public class MessageItemViewHolder extends ItemViewHolder<Message, MessageItemViewModel, UiMessageItemBinding, MessageStyle> {
    ...
    public MessageItemViewHolder(ViewGroup parent, MessageItemViewModel messageItemViewModel, MessageCell messageCell) {
